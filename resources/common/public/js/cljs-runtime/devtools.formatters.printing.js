...
var len__5722__auto___63451 = arguments.length;
var i__5723__auto___63452 = (0);
while(true){
if((i__5723__auto___63452 < len__5722__auto___63451)){
args__5728__auto__.push((arguments[i__5723__auto___63452]));

var G__63453 = (i__5723__auto___63452 + (1));
i__5723__auto___63452 = G__63453;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5729__auto__);
});
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq63375){
...
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63376,G__63377,seq63375__$2);
}));
...
if(cljs.core.truth_((function (){var or__4998__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4998__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_((function (){var and__4996__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__4996__auto__){
var or__4998__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__63412_SHARP_){
return (!((cljs.core.meta(p1__63412_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__4996__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63419__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__4998__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e63420){var _e__62302__auto__ = e63420;
return false;
}})();
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
...
}catch (e63424){var _e__62302__auto__ = e63424;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__63432 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__63433 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__63433);
...
var map__63434 = opts;
var map__63434__$1 = cljs.core.__destructure_map(map__63434);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63434__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__63432);
}});
...
var temp__5821__auto___63467 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5821__auto___63467)){
var managed_print_level_63468 = temp__5821__auto___63467;
var _STAR_print_level_STAR__orig_val__63443_63469 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__63444_63470 = managed_print_level_63468;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__63444_63470);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__63439_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__63439_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__63443_63469);
}} else {
job_fn();
}
