...
*/
devtools.toolbox.t_devtools$toolbox65789 = (function (obj,header,style,tag,meta65790){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
this.meta65790 = meta65790;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(devtools.toolbox.t_devtools$toolbox65789.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_65791,meta65790__$1){
var self__ = this;
var _65791__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox65789(self__.obj,self__.header,self__.style,self__.tag,meta65790__$1));
}));

(devtools.toolbox.t_devtools$toolbox65789.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_65791){
var self__ = this;
var _65791__$1 = this;
return self__.meta65790;
}));

(devtools.toolbox.t_devtools$toolbox65789.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox65789.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox65789.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox65789.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox65789.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta65790","meta65790",-778438949,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox65789.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox65789.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox65789");

(devtools.toolbox.t_devtools$toolbox65789.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"devtools.toolbox/t_devtools$toolbox65789");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox65789.
 */
devtools.toolbox.__GT_t_devtools$toolbox65789 = (function devtools$toolbox$__GT_t_devtools$toolbox65789(obj,header,style,tag,meta65790){
return (new devtools.toolbox.t_devtools$toolbox65789(obj,header,style,tag,meta65790));
});
...
return (new devtools.toolbox.t_devtools$toolbox65789(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
