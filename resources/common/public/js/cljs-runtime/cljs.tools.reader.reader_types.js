...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_69752 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_69752(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_69753 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_69753(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_69756 = (function (reader,ch){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_69756(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_69760 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_69760(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_69766 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_69766(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_69767 = (function (reader){
var x__5346__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_69767(reader);
}
});
...
var G__69804 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__69805 = s.append(c);
c = G__69804;
s = G__69805;
continue;
}
