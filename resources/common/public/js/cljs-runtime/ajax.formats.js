...
var G__72918 = request;
var G__72919 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__72918,G__72919) : ajax.formats.get_format.call(null,G__72918,G__72919));
} else {
...
return cljs.core.some((function (p1__72921_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__72921_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__72922){
var map__72923 = p__72922;
var map__72923__$1 = cljs.core.__destructure_map(map__72923);
var request = map__72923__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72923__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__72931 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__72931.cljs$core$IFn$_invoke$arity$1 ? fexpr__72931.cljs$core$IFn$_invoke$arity$1(response) : fexpr__72931.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__72933){
var map__72935 = p__72933;
var map__72935__$1 = cljs.core.__destructure_map(map__72935);
var request = map__72935__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72935__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__72932_SHARP_){
return ajax.formats.get_accept_entries(request,p1__72932_SHARP_);
