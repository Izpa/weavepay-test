...
(reagent.impl.template.UnsafeHTML.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
var G__74064 = o;
reagent.impl.template.goog$module$goog$object.set(G__74064,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__74084__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__74084 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__74085__i = 0, G__74085__a = new Array(arguments.length -  0);
while (G__74085__i < G__74085__a.length) {G__74085__a[G__74085__i] = arguments[G__74085__i + 0]; ++G__74085__i;}
  args = new cljs.core.IndexedSeq(G__74085__a,0,null);
} 
return G__74084__delegate.call(this,args);};
G__74084.cljs$lang$maxFixedArity = 0;
G__74084.cljs$lang$applyTo = (function (arglist__74086){
var args = cljs.core.seq(arglist__74086);
return G__74084__delegate(args);
});
G__74084.cljs$core$IFn$_invoke$arity$variadic = G__74084__delegate;
return G__74084;
})()
;
} else {
...
var G__74065 = o;
reagent.impl.template.goog$module$goog$object.set(G__74065,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__74089__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__74089 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__74091__i = 0, G__74091__a = new Array(arguments.length -  0);
while (G__74091__i < G__74091__a.length) {G__74091__a[G__74091__i] = arguments[G__74091__i + 0]; ++G__74091__i;}
  args = new cljs.core.IndexedSeq(G__74091__a,0,null);
} 
return G__74089__delegate.call(this,args);};
G__74089.cljs$lang$maxFixedArity = 0;
G__74089.cljs$lang$applyTo = (function (arglist__74092){
var args = cljs.core.seq(arglist__74092);
return G__74089__delegate(args);
});
G__74089.cljs$core$IFn$_invoke$arity$variadic = G__74089__delegate;
return G__74089;
})()
;
} else {
...
var G__74066 = props;
var G__74066__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74066,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__74066);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74066__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4998__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__74067 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74067,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__74067;
}
})(),id_class);
...
var temp__5823__auto___74094 = (function (){var and__4996__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___74094)){
var d_74095 = temp__5823__auto___74094;
if((d_74095 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_74095.s}));
} else {
...
var G__74068 = (cljs.core.count(argv) - first_child);
switch (G__74068) {
case (0):
...
var vec__74069 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74069,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74069,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74069,(2),null);
...
var temp__5827__auto___74101 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___74101 == null)){
} else {
var key_74103 = temp__5827__auto___74101;
(jsprops.key = key_74103);
}
...
var temp__5827__auto___74104 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___74104 == null)){
} else {
var key_74105 = temp__5827__auto___74104;
(jsprops.key = key_74105);
}
...
var temp__5827__auto___74110 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___74110 == null)){
} else {
var key_74111 = temp__5827__auto___74110;
(jsprops.key = key_74111);
}
...
var temp__5827__auto___74117 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___74117 == null)){
} else {
var key_74118 = temp__5827__auto___74117;
(jsprops.key = key_74118);
}
...
var temp__5827__auto___74119 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___74119 == null)){
} else {
var key_74120 = temp__5827__auto___74119;
(jsprops.key = key_74120);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74072_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__74072_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__74073 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74073,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74073,(1),null);
...
break;
default:
var G__74128 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__74129 = compiler;
v = G__74128;
compiler = G__74129;
continue;
...
var G__74077 = tag;
var G__74077__$1 = (((G__74077 instanceof cljs.core.Keyword))?G__74077.fqn:null);
switch (G__74077__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template74079 = (function (opts,id,fn_to_element,parse_fn,meta74080){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta74080 = meta74080;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template74079.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_74081,meta74080__$1){
var self__ = this;
var _74081__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template74079(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta74080__$1));
}));

(reagent.impl.template.t_reagent$impl$template74079.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_74081){
var self__ = this;
var _74081__$1 = this;
return self__.meta74080;
}));

(reagent.impl.template.t_reagent$impl$template74079.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template74079.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template74079.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template74079.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template74079.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template74079.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta74080","meta74080",-1434885678,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template74079.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template74079.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template74079");

(reagent.impl.template.t_reagent$impl$template74079.cljs$lang$ctorPrWriter = (function (this__5283__auto__,writer__5284__auto__,opt__5285__auto__){
return cljs.core._write(writer__5284__auto__,"reagent.impl.template/t_reagent$impl$template74079");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template74079.
 */
reagent.impl.template.__GT_t_reagent$impl$template74079 = (function reagent$impl$template$__GT_t_reagent$impl$template74079(opts,id,fn_to_element,parse_fn,meta74080){
return (new reagent.impl.template.t_reagent$impl$template74079(opts,id,fn_to_element,parse_fn,meta74080));
});
...
return (new reagent.impl.template.t_reagent$impl$template74079(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
