...
var G__73093 = format;
var G__73093__$1 = (((G__73093 instanceof cljs.core.Keyword))?G__73093.fqn:null);
switch (G__73093__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__73104 = cljs.core.second(format);
var G__73105 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__73104,G__73105) : ajax.easy.keyword_response_format_element.call(null,G__73104,G__73105));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__73108 = format;
var G__73108__$1 = (((G__73108 instanceof cljs.core.Keyword))?G__73108.fqn:null);
switch (G__73108__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__73117_SHARP_){
return ajax.easy.keyword_response_format_element(p1__73117_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__73122){
var map__73123 = p__73122;
var map__73123__$1 = cljs.core.__destructure_map(map__73123);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73123__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73123__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73123__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__73124){
var vec__73126 = p__73124;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73126,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73126,(1),null);
var fexpr__73129_73164 = (cljs.core.truth_(ok)?h:e);
(fexpr__73129_73164.cljs$core$IFn$_invoke$arity$1 ? fexpr__73129_73164.cljs$core$IFn$_invoke$arity$1(result) : fexpr__73129_73164.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__73137){
var map__73138 = p__73137;
var map__73138__$1 = cljs.core.__destructure_map(map__73138);
var opts = map__73138__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73138__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73138__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73138__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73138__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73138__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
