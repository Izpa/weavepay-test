...
var temp__5821__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var reader = (function (){var or__4998__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4998__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return (128);
...
var map__63326 = top_item;
var map__63326__$1 = cljs.core.__destructure_map(map__63326);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63326__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63326__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63326__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e63325){var _e = e63325;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___63358 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5821__auto___63358)){
var seen_errors_63359 = temp__5821__auto___63358;
if(cljs.core.truth_(seen_errors_63359.has(self))){
} else {
seen_errors_63359.add(self);

var temp__5823__auto___63360 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5823__auto___63360)){
var sense_63362 = temp__5823__auto___63360;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_63362)].join(''));
} else {
}
}
} else {
...
var temp__5823__auto__ = devtools.hints.error_object_sense(error);
