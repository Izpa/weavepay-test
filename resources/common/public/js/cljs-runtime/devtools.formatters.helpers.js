...
var G__63357 = devtools.prefs.pref(v);
v = G__63357;
continue;
} else {
return v;
...
var and__4996__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4996__auto__){
var and__4996__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
var or__4998__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e63319){var _e__62302__auto__ = e63319;
return false;
}})();
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
var or__4998__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e63321){var _e__62302__auto__ = e63321;
return false;
}})();
...
}catch (e63323){var _e__62302__auto__ = e63323;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__4996__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__4996__auto__)){
var and__4996__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__4996__auto____$1){
...
var and__4996__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__4996__auto__)){
...
var or__4998__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var and__4996__auto__ = (function (){var or__4998__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var vec__63336 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63336,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63336,(1),null);
...
var and__4996__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4996__auto__)){
...
return cljs.core.some((function (p1__63347_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__63347_SHARP_);
}),template);
});
