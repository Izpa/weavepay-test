...
var len__5722__auto___63193 = arguments.length;
var i__5723__auto___63194 = (0);
while(true){
if((i__5723__auto___63194 < len__5722__auto___63193)){
args__5728__auto__.push((arguments[i__5723__auto___63194]));

var G__63195 = (i__5723__auto___63194 + (1));
i__5723__auto___63194 = G__63195;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5729__auto__);
});
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq63078){
var G__63079 = cljs.core.first(seq63078);
var seq63078__$1 = cljs.core.next(seq63078);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63079,seq63078__$1);
}));
...
return cljs.core.some((function (p1__63104_SHARP_){
return (p1__63104_SHARP_ === object);
}),history__$1);
});
...
var args__5728__auto__ = [];
var len__5722__auto___63196 = arguments.length;
var i__5723__auto___63197 = (0);
while(true){
if((i__5723__auto___63197 < len__5722__auto___63196)){
args__5728__auto__.push((arguments[i__5723__auto___63197]));

var G__63199 = (i__5723__auto___63197 + (1));
i__5723__auto___63197 = G__63199;
continue;
} else {
}
break;
...
var argseq__5729__auto__ = ((((1) < args__5728__auto__.length))?(new cljs.core.IndexedSeq(args__5728__auto__.slice((1)),(0),null)):null);
return devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5729__auto__);
});

(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__63126){
var vec__63127 = p__63126;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63127,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq63117){
var G__63118 = cljs.core.first(seq63117);
var seq63117__$1 = cljs.core.next(seq63117);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63118,seq63117__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5728__auto__ = [];
var len__5722__auto___63200 = arguments.length;
var i__5723__auto___63201 = (0);
while(true){
if((i__5723__auto___63201 < len__5722__auto___63200)){
args__5728__auto__.push((arguments[i__5723__auto___63201]));

var G__63202 = (i__5723__auto___63201 + (1));
i__5723__auto___63201 = G__63202;
continue;
} else {
}
break;
...
return devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5729__auto__);
});

(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__63150){
var vec__63154 = p__63150;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63154,(0),null);
...
var _STAR_ = (function (p__63158){
var vec__63159 = p__63158;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63159,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63159,(1),null);
if(cljs.core.truth_((function (){var and__4996__auto__ = seq_SINGLEQUOTE_d_map_QMARK_;
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq63140){
var G__63142 = cljs.core.first(seq63140);
var seq63140__$1 = cljs.core.next(seq63140);
var G__63143 = cljs.core.first(seq63140__$1);
var seq63140__$2 = cljs.core.next(seq63140__$1);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63142,G__63143,seq63140__$2);
}));
...
var valid_kw_QMARK_ = (function (){var and__4996__auto__ = first_kw;
if(cljs.core.truth_(and__4996__auto__)){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4998__auto__ = path;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return cljs.core.PersistentVector.EMPTY;
...
var or__4998__auto__ = devtools.formatters.state.ignore_path_in_fake_vector(parent_object,object,path_info);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
var or__4998__auto____$1 = devtools.formatters.state.find_path_in_fake_vector(parent_object,path_info);
if(cljs.core.truth_(or__4998__auto____$1)){
return or__4998__auto____$1;
} else {
var or__4998__auto____$2 = devtools.formatters.state.find_path(parent_object,object,path_info);
