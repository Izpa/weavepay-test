...
var and__4996__auto__ = cljs.core.not(devtools.formatters.state.prevent_recursion_QMARK_());
if(and__4996__auto__){
var or__4998__auto__ = devtools.formatters.helpers.cljs_value_QMARK_(value);
...
}catch (e65827){var _e__62302__auto__ = e65827;
return false;
...
}catch (e65833){var _e__62302__auto__ = e65833;
return false;
...
}catch (e65838){var _e__62302__auto__ = e65838;
return false;
...
}catch (e65840){var _e__62302__auto__ = e65840;
return false;
...
}catch (e65846){var _e__62302__auto__ = e65846;
return false;
}})())){
...
}catch (e65848){var _e__62302__auto__ = e65848;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__65854 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__65855 = (function (){var or__4998__auto__ = config;
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__65855);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__65854);
}});
});
...
return (function() { 
var G__65871__delegate = function (args){
try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
}catch (e65863){var e = e65863;
...
var G__65871 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65872__i = 0, G__65872__a = new Array(arguments.length -  0);
while (G__65872__i < G__65872__a.length) {G__65872__a[G__65872__i] = arguments[G__65872__i + 0]; ++G__65872__i;}
  args = new cljs.core.IndexedSeq(G__65872__a,0,null);
} 
return G__65871__delegate.call(this,args);};
G__65871.cljs$lang$maxFixedArity = 0;
G__65871.cljs$lang$applyTo = (function (arglist__65873){
var args = cljs.core.seq(arglist__65873);
return G__65871__delegate(args);
});
G__65871.cljs$core$IFn$_invoke$arity$variadic = G__65871__delegate;
return G__65871;
})()
;
});
...
var pre_handler = (function (){var or__4998__auto__ = devtools.prefs.pref(pre_handler_key);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
...
var post_handler = (function (){var or__4998__auto__ = devtools.prefs.pref(post_handler_key);
if(cljs.core.truth_(or__4998__auto__)){
return or__4998__auto__;
} else {
return cljs.core.identity;
