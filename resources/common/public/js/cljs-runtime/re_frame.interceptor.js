...
var len__5722__auto___74583 = arguments.length;
var i__5723__auto___74584 = (0);
while(true){
if((i__5723__auto___74584 < len__5722__auto___74583)){
args__5728__auto__.push((arguments[i__5723__auto___74584]));

var G__74585 = (i__5723__auto___74584 + (1));
i__5723__auto___74584 = G__74585;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__74520){
var map__74522 = p__74520;
var map__74522__$1 = cljs.core.__destructure_map(map__74522);
var m = map__74522__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74522__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74522__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74522__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74522__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5821__auto___74586 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5821__auto___74586){
var unknown_keys_74587 = temp__5821__auto___74586;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_74587], 0));
} else {
}
} else {
}

var G__74524 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4998__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74524,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__74524;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq74519){
var self__5708__auto__ = this;
return self__5708__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq74519));
}));

re_frame.interceptor.get_effect = (function re_frame$interceptor$get_effect(var_args){
var G__74526 = arguments.length;
switch (G__74526) {
case 1:
...
var args__5728__auto__ = [];
var len__5722__auto___74591 = arguments.length;
var i__5723__auto___74592 = (0);
while(true){
if((i__5723__auto___74592 < len__5722__auto___74591)){
args__5728__auto__.push((arguments[i__5723__auto___74592]));

var G__74593 = (i__5723__auto___74592 + (1));
i__5723__auto___74592 = G__74593;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq74531){
...
var G__74534 = cljs.core.first(seq74531__$2);
var seq74531__$3 = cljs.core.next(seq74531__$2);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74532,G__74533,G__74534,seq74531__$3);
}));
...
var args__5728__auto__ = [];
var len__5722__auto___74600 = arguments.length;
var i__5723__auto___74601 = (0);
while(true){
if((i__5723__auto___74601 < len__5722__auto___74600)){
args__5728__auto__.push((arguments[i__5723__auto___74601]));

var G__74602 = (i__5723__auto___74601 + (1));
i__5723__auto___74601 = G__74602;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq74539){
var G__74540 = cljs.core.first(seq74539);
var seq74539__$1 = cljs.core.next(seq74539);
var G__74541 = cljs.core.first(seq74539__$1);
var seq74539__$2 = cljs.core.next(seq74539__$1);
var G__74542 = cljs.core.first(seq74539__$2);
var seq74539__$3 = cljs.core.next(seq74539__$2);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74540,G__74541,G__74542,seq74539__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__74546,interceptor,direction){
var map__74547 = p__74546;
var map__74547__$1 = cljs.core.__destructure_map(map__74547);
var context = map__74547__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74547__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var args__5728__auto__ = [];
var len__5722__auto___74614 = arguments.length;
var i__5723__auto___74615 = (0);
while(true){
if((i__5723__auto___74615 < len__5722__auto___74614)){
args__5728__auto__.push((arguments[i__5723__auto___74615]));

var G__74616 = (i__5723__auto___74615 + (1));
i__5723__auto___74615 = G__74616;
continue;
} else {
}
break;
...
return re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5729__auto__);
});
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq74558){
var G__74559 = cljs.core.first(seq74558);
var seq74558__$1 = cljs.core.next(seq74558);
var self__5707__auto__ = this;
return self__5707__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74559,seq74558__$1);
}));
...
var map__74564 = cljs.core.ex_data(re_frame_error);
var map__74564__$1 = cljs.core.__destructure_map(map__74564);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74564__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74564__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74564__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__74571 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__74571.cljs$core$IFn$_invoke$arity$1 ? fexpr__74571.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__74571.call(null,interceptor));
})();
...
}catch (e74577){var e = e74577;
var G__74578 = cljs.core.ex_cause(e);
var G__74579 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__74578,G__74579) : error_handler.call(null,G__74578,G__74579));
}}
});
