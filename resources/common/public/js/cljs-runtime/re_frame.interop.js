...
return [(function (){var pred__74202 = cljs.core.instance_QMARK_;
var expr__74203 = reactive_val;
if(cljs.core.truth_((pred__74202.cljs$core$IFn$_invoke$arity$2 ? pred__74202.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__74203) : pred__74202.call(null,reagent.ratom.RAtom,expr__74203)))){
return "ra";
} else {
if(cljs.core.truth_((pred__74202.cljs$core$IFn$_invoke$arity$2 ? pred__74202.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__74203) : pred__74202.call(null,reagent.ratom.RCursor,expr__74203)))){
return "rc";
} else {
if(cljs.core.truth_((pred__74202.cljs$core$IFn$_invoke$arity$2 ? pred__74202.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__74203) : pred__74202.call(null,reagent.ratom.Reaction,expr__74203)))){
return "rx";
} else {
if(cljs.core.truth_((pred__74202.cljs$core$IFn$_invoke$arity$2 ? pred__74202.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__74203) : pred__74202.call(null,reagent.ratom.Track,expr__74203)))){
return "tr";
} else {
return "other";
}
